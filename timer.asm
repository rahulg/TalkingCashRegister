...
; ^^^^^^^^^^^^^^^^^  Start of User Main Routine  ^^^^^^^^^^^^^^^^^^
	...
	MOV DS:LED_VALS[0], 00h
	MOV DS:LED_VALS[1], 1Ah
	MOV DS:LED_VALS[2], 10h
	MOV DS:LED_VALS[3], 04h
	MOV DS:LED_VALS[4], 05h
	MOV DS:LED_VALS[5], 06h
