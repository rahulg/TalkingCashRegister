...
; ^^^^^^^^^^^^^^^^^  Start of User Main Routine  ^^^^^^^^^^^^^^^^^^
	...
	MOV BX, 0
	MOV DS:SOUND_QUEUE[BX], SOUND_TWENTY
	INC DS:SOUND_QUEUE_HEAD

	XOR BH, BH
	MOV BL, DS:SOUND_QUEUE_HEAD
	MOV DS:SOUND_QUEUE[BX], SOUND_THOUSAND
	INC DS:SOUND_QUEUE_HEAD
...
NEXT:
	...
	XOR BH, BH
	MOV BL, DS:SOUND_QUEUE_HEAD
	MOV CL, SOUND_PROD_BASE
	ADD CL, 4
	MOV DS:SOUND_QUEUE[BX], CL
	INC DS:SOUND_QUEUE_HEAD
	...
	XOR BH, BH
	MOV BL, DS:SOUND_QUEUE_HEAD
	MOV DS:SOUND_QUEUE[BX], SOUND_FOR
	INC DS:SOUND_QUEUE_HEAD
	...
	XOR BH, BH
	MOV BL, DS:SOUND_QUEUE_HEAD
	MOV DS:SOUND_QUEUE[BX], SOUND_CHANGE
	INC DS:SOUND_QUEUE_HEAD
	...
	XOR BH, BH
	MOV BL, DS:SOUND_QUEUE_HEAD
	MOV DS:SOUND_QUEUE[BX], SOUND_PLEASE
	INC DS:SOUND_QUEUE_HEAD
